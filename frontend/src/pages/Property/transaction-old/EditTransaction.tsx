...
const EditTransaction: FC<Props> = ({ show, setShow, fetchData, data }) => {
  ...
  return (
    <>
      <div
        id="Tran-edit-modal"
        className={`fixed top-0 left-0 z-[80] w-full h-full overflow-x-hidden bg-gray-500 bg-opacity-50 backdrop-blur-sm transition-opacity duration-300 ease-in-out ${show ? "opacity-100" : "opacity-0 pointer-events-none"}`}
        ...
        <div className="flex justify-center items-center min-h-screen m-2">
          <div className="w-full max-w-6xl bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
            <div className="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
              <h3 id="Tran-edit-modal-label" className="font-bold text-gray-800 dark:text-white">
                Edit Transaction
              </h3>
              <button
                type="button"
            ...
            <div className="w-full max-h-[100vh] overflow-y-auto">
              <form >
                <div className="m-2 grid gap-4 lg:gap-6 border border-gray-300 dark:border-gray-500 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="rounded-lg py-3 px-4 block w-full mt-2 border-gray-200  text-sm border focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-900 dark:border-gray-700 dark:text-gray-100 dark:placeholder-gray-500 dark:focus:ring-gray-600 bg-slate-200 uppercase focus:outline-none focus:ring-0 dark:focus:border-blue-500"
                        readOnly
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 lg:gap-6">
                    <div>
                      ...
                      <input
                        ...
                        value={formData.area}
                        onChange={handleChange}
                        className="rounded-lg py-3 px-4 block w-full mt-2 border-gray-200  text-sm border focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100 dark:placeholder-gray-500 dark:focus:ring-gray-600 bg-slate-100 uppercase focus:outline-none focus:ring-0 dark:focus:border-blue-500 text-right" placeholder="Enter Area" />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className="rounded-lg py-3 px-4 block w-full mt-2 border-gray-200  text-sm border focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100 dark:placeholder-gray-500 dark:focus:ring-gray-600 bg-slate-100 uppercase focus:outline-none focus:ring-0 dark:focus:border-blue-500 text-right" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className="rounded-lg py-3 px-4 block w-full mt-2 border-gray-200  text-sm border focus:border-blue-500 focus:ring-blue-500 
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className="rounded-lg py-3 px-4 block w-full mt-2 border-gray-200  text-sm border focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100 dark:placeholder-gray-500 dark:focus:ring-gray-600 bg-slate-100 uppercase focus:outline-none focus:ring-0 dark:focus:border-blue-500" rows={3} />
                    </div>
                  </div>
                        ...
                        {data.files?.map((file: any, index: number) => (
                          <tr key={index}>
                            ...
                            <td className="py-2 px-2">
                              <select
                                value={file.doc_type}
                                className="py-3 px-4 pe-9 block w-[15rem] sm:w-full rounded-lg border-gray-200 text-sm border focus:outline-none bg-slate-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100"
                                disabled
                              >
                            ...
                            <td className="py-3 px-2">
                              <input
                                ...
                                readOnly
                                className="rounded-lg py-3 px-4 block w-[15rem] sm:w-full mt-2 border-gray-200 text-sm border focus:outline-none bg-slate-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100"
                              />
                            </td>
