                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-4 text-center">
                      <div className="flex justify-center items-center space-x-2">
                        ...
                        <span className="text-gray-600 dark:text-gray-400">Loading consignees...</span>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-4 text-center">
                      <div className="flex flex-col items-center justify-center py-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-lg">No consignees found</p>
                        <p className="text-gray-500 dark:text-gray-500 text-sm">Try adjusting your search or add a new consignee</p>
                      </div>
                    </td>
                  </tr>
                )}
