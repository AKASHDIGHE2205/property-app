...
const ConsigneeView = () => {
  ...
  return (
    <div className="h-screen w-full m-3 border p-2 rounded-lg" >
      <h1 className="flex justify-center items-center text-2xl font-semibold">Consignee Details</h1>
      ...
      {showCreateModal && <ConsigneeCreate show={showCreateModal} setShow={setShowCreateModal} fetchData={fetchData} />}
      {showEditModal && <ConsigneeEdit show={showEditModal} setShow={setShowEditModal} fetchData={fetchData} selectedConsignee={selectedConsignee} />}
    </div>
  )
}
