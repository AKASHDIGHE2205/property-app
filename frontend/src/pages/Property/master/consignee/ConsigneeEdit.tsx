...
import { editConsignee } from "../../../../services/Property/master/PmasterApis"
...
const ConsigneeEdit: FC<props> = ({ show, setShow, fetchData, selectedConsignee }) => {
  ...
  useEffect(() => {
    if (selectedConsignee) {
      setInput({
        id: selectedConsignee.id || 0,
        name: selectedConsignee.name || "",
        status: selectedConsignee.status || "",
      });
    }
  }, [selectedConsignee]);
      ...
      <div className="flex justify-center items-center min-h-screen m-2">
        <div className="w-full max-w-lg bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
          <div className="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
            <h3 id="Consigner-edit-modal-label" className="font-bold text-gray-800 dark:text-white">
              Edit Consigner
            </h3>
            <button
              type="button"
