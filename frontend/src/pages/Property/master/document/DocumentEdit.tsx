...
import { editDocument } from "../../../../services/Property/master/PmasterApis"
...
const DocumentEdit: FC<props> = ({ show, setShow, fetchData, selectedDocument }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-labelledby="Document-edit-modal-label"
    >
      <div className="flex justify-center items-center min-h-screen m-2">
        <div className="w-full max-w-lg bg-white dark:bg-slate-800 rounded-xl shadow-sm overflow-hidden">
          <div className="flex justify-between items-center py-3 px-4 border-b dark:border-slate-700">
            <h3 id="Document-edit-modal-label" className="font-bold text-slate-800 dark:text-white">
              Edit Document
            </h3>
            <button
              type="button"
