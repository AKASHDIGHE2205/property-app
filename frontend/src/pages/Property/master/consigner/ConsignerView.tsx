...
const ConsignerView = () => {
  ...
  return (
    <div className="h-screen w-full m-3 border p-2 rounded-lg" >
      <h1 className="flex justify-center items-center text-2xl font-semibold">Consignor Details</h1>
      ...
      {showCreateModal && <ConsignerCreate show={showCreateModal} setShow={setShowCreateModal} fetchData={fetchData} />}
      {showEditModal && <ConsignerEdit show={showEditModal} setShow={setShowEditModal} fetchData={fetchData} selectedConsigner={selectedConsigner} />}
    </div>
  )
}
