                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-4 text-center">
                      <div className="flex justify-center items-center space-x-2">
                        ...
                        <span className="text-slate-600 dark:text-slate-400">Loading consignors...</span>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-2 text-center">
                      <div className="flex flex-col items-center justify-center">
                        <p className="text-slate-600 dark:text-slate-400 text-lg">No consignors found</p>
                        <p className="text-slate-500 dark:text-slate-500 text-sm">Try adjusting your search or add a new consignor</p>
                      </div>
                    </td>
                  </tr>
                )}
