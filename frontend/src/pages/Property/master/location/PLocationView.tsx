                ...
                {loading ? (
                  ...
                  currentItems.map((item: any) => (
                    <tr key={item.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900 dark:text-slate-200 uppercase">
                        {item.id}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-slate-200 uppercase">
                        {item.name}
                      </td>
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-2 text-center">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-slate-500 dark:text-slate-500 text-sm">Try adjusting your search or add a new location</p>
                      </div>
                    </td>
                  </tr>
                )}
