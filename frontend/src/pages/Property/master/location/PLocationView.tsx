...
const PLocationView = () => {
  ...
  return (
    <div className="h-screen w-full m-3 border p-2 rounded-lg" >
      ...
      {showCreateModal && <PLocationCreate show={showCreateModal} setShow={setShowCreateModal} fetchData={fetchData} />}
      {showEditModal && <PLocationEdit show={showEditModal} setShow={setShowEditModal} fetchData={fetchData} selectedLocation={selectedLocation} />}
    </div>
  )
}
