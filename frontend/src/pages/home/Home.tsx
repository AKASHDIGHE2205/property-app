const Home = () => {
  return (
    <>
      <div className=" h-[42rem] w-full bg-gradient-to-br from-blue-100 via-purple-200 to-indigo-300 dark:bg-gradient-to-br dark:from-indigo-900 dark:via-purple-900 dark:to-blue-900 transition-colors duration-200">
        {/* Navigation - Minimal */}
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="bg-gray-50 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium py-3 px-8 rounded-lg transition-colors dark:text-black">
                  How It Works →
                </button>
              </div>
            </div>
            ...
            <div className="md:w-1/2 mt-10 md:mt-0">
              <div className="relative rounded-xl overflow-hidden shadow-lg dark:shadow-xl dark:shadow-gray-800/20">
                <img
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200 hidden">
        {/* Navigation */}
        <nav className="px-4 py-6 max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-6">
            ...
            <a href="#property" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Property Tools</a>
            <a href="#document" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Document Tracking</a>
          </div>
        </nav>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-200 font-medium py-3 px-8 rounded-lg transition-colors">
                  See Demo →
                </button>
              </div>
            </div>
        ...
        <div id="document" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-sm hover:shadow-md dark:hover:shadow-gray-700/30 transition-shadow">
                <div className="text-4xl mb-4">{feature.icon}</div>
                <h3 className="text-xl font-semibold mb-3 dark:text-gray-100">{feature.title}</h3>
        ...
        <div id="property" className="bg-gray-100 dark:bg-gray-800 py-20">
