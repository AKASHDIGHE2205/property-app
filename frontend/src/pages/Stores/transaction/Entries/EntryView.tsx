  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 dark:bg-gray-900 p-4 md:p-6">
      <div className="max-w-7xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden border border-gray-200 dark:border-gray-700">
        ...
        {/* Action Buttons */}
        <div className="flex flex-row justify-between items-start sm:items-center p-4 md:p-6 border-b border-gray-200 dark:border-gray-700 gap-4">
          {/* Filter Toggle */}
          <button
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead className="bg-gray-100 dark:bg-gray-700 sticky top-0">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider" hidden>
                    Remark
                  </th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                    Rack No.
                ...
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={14} className="px-6 py-2 text-center">
                      <div className="flex flex-col items-center justify-center py-6">
                        <p className="text-gray-600 dark:text-gray-400 text-lg">No entries found</p>
                  ...
                  currentItems.map((item: Entry) => (
                    <tr key={item.doc_code} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-200 max-w-[180px] overflow-x-auto custom-scrollbar hidden">
                        {item.remark}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200">
                        {item.cub_code}
