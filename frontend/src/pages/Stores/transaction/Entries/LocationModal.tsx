      ...
      <div className="flex justify-center items-center min-h-screen m-2">
        <div className="w-full max-w-lg bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
          <div className="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
            <h3 id="loc-modal-label" className="font-bold text-gray-800 dark:text-white">
              Select Location
            </h3>
            <button
              type="button"
          ...
          <div className="px-4 max-h-[70vh] overflow-y-auto">
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead className="sticky top-0 bg-gray-50 dark:bg-gray-900">
                <tr>
                  <th className="px-2 py-3 text-start text-xs font-medium text-gray-500 uppercase">Location Code</th>
                  <th className="px-2 py-3 text-start text-xs font-medium text-gray-500 uppercase">Location Name</th>
