...
import { editSection } from "../../../../services/Stores/master/MasterApis";
...
const EditSection: FC<props> = ({ show, setShow, fetchData, selectedSec }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-labelledby="Sec-edit-modal-label"
    >
      <div className="flex justify-center items-center min-h-screen m-2">
        <div className="w-full max-w-lg bg-white dark:bg-slate-800 rounded-xl shadow-sm overflow-hidden">
          <div className="flex justify-between items-center py-3 px-4 border-b dark:border-slate-700">
            <h3 id="Sec-edit-modal-label" className="font-bold text-slate-800 dark:text-white">
              Edit Location
            </h3>
            <button
              type="button"
