                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-4 text-center">
                      <div className="flex justify-center items-center space-x-2">
                        ...
                        <span className="text-slate-600 dark:text-slate-400">Loading sections...</span>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-4 text-center">
                      <div className="flex flex-col items-center justify-center py-8">
                        <FiLayers className="text-slate-400 text-4xl mb-2" />
                        <p className="text-slate-600 dark:text-slate-400 text-lg">No sections found</p>
                      </div>
                    </td>
                  </tr>
                ) : (
