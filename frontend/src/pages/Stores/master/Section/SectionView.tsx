...
import { getAllSection } from "../../../../services/Stores/master/MasterApis";
  ...
  return (
    <>
      <div className="h-screen w-full m-3 border p-2 rounded-lg">
        <h1 className="flex justify-center items-center text-2xl font-semibold ">Section Details</h1>
      ...
      {showCreateModal && <CreateSection show={showCreateModal} setShow={setShowCreateModal} fetchData={fetchData} />}
      {showEditModal && <EditSection show={showEditModal} setShow={setShowEditModal} fetchData={fetchData} selectedSec={selectedSec} />}
    </>
  )
}
