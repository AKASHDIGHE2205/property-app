...
import { tablehead, tablebody } from "../../../../constant/BaseUrl";
import Paginations from "../../../../helper/Pagination";
import { getAllBranches } from "../../../../services/Stores/master/MasterApis";
...
const BranchView = () => {
  ...
  return (
    <div className="h-screen w-full m-3 border p-2 rounded-lg" >
      <h1 className="flex justify-center items-center text-2xl font-semibold ">Branch Details</h1>
      ...
      <div className="flex-grow overflow-auto">
        ...
        {showCreateModal && <BranchCreate show={showCreateModal} setShow={setShowCreateModal} fetchData={fetchData} />}
        {showEditModal && <BranchEdit show={showEditModal} setShow={setShowEditModal} fetchData={fetchData} selectedBranch={selectedBranch} />}
      </div>
      <div>
      </div>
    </div>
