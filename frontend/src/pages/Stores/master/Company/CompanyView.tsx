...
const CompanyView = () => {
  ...
  return (
    <>
      <div className="h-screen w-full m-3 border dark:border-gray-500 p-2 rounded-lg">
        <h1 className="flex justify-center items-center text-2xl font-semibold ">Firm Details</h1>
        ...
        <div className="flex-grow overflow-auto">
          <div className="border dark:border-gray-800 rounded-md">
